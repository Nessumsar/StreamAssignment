...
public class StreamAssignment {
    ...
    public void task3(){
        ...
        Stream<Person> pStream = JsonReader.getInstance().read().stream();
        List<Person> filterList = pStream
                       .filter(s -> s.getLastName().equalsIgnoreCase("Andersson"))
    ...
    @Test
    public void task14(){
        LocalDate[] _2020_dates = Stream.iterate(LocalDate.ofYearDay(2020,1),
